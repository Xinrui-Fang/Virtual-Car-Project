...
%% 5.save data
save('controller_data_20231008.mat','data_input','data_output')
...
Aeq = zeros(5,5);
tic;
Wmin = fminsearch(@(W) identify(x,y,N,N_end,R,W),W0,options);
toc;
Wmin
save('Appcontroller_20231008.mat','Wmin')
